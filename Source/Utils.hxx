...
namespace FWMFW
{
	...
	namespace Utils
	{
		...
		std::string replaceChars(const std::string& str, const char findChar, const char replacement, bool stopAtFirstHit = true);
		...
		std::vector<std::string> getFilesInDirectory(const std::string& dir, const std::string& fileEnding, bool traverseAll = false);
	} // namespace Utils
} // namespace FWMFW
